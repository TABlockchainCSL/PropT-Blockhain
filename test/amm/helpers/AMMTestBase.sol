...
contract MockOracle is IPriceOracle {
    ...
    function setPriceWithTimestamp(uint256 newPrice, uint256 newUpdatedAt) external {
        price = newPrice;
