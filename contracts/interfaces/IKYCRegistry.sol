...
interface IKYCRegistry {
    ...
    event ContractApproved(address indexed contractAddr, address indexed approvedBy);
    event ContractRemoved(address indexed contractAddr, address indexed removedBy);
